...
2. Render a screenshot at a key moment:
   ...
   The command prints the path of a PNG under `/tmp`; open that file to view the screenshot. Some timestamps return `failed to capture screenshot` — retry at a nearby or earlier timestamp.
